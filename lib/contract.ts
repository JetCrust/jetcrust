// Rental agreement shown at booking. This is a starting template — replace the
// wording with your finalised, ideally lawyer-reviewed terms. When you change the
// substance, bump CONTRACT_VERSION in .env.local so acceptance records stay accurate.
export const CONTRACT_VERSION = process.env.CONTRACT_VERSION || "v1";

export const CONTRACT_TEXT = `JET CRUST — SHORT-TERM RENTAL AGREEMENT

1. The booking. By requesting a booking you ask to reserve the property for the dates and party stated. A booking is a request only until Jet Crust approves it in writing. Jet Crust may decline any request at its discretion.

2. Payment. When you request a booking, your card is authorised (a hold is placed) for the total shown. Your card is charged only if and when Jet Crust approves the booking. If the booking is declined, the hold is released and no charge is made.

3. Guests. Only the number of guests stated may stay at the property. The property is not to be used for events, parties or commercial filming without prior written consent.

4. Care of the property. You agree to treat the property and its contents with care, to follow the house rules provided on arrival, and to report any damage promptly. You are responsible for damage caused during your stay beyond fair wear and tear.
